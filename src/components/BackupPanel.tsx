    ...
    <TooltipProvider>
      <Dialog open={isOpen} onOpenChange={setIsOpen}>
        <Tooltip>
          ...
          <TooltipContent>
            <p>Sistema de backup e restauração de dados</p>
          </TooltipContent>
        </Tooltip>
          ...
          <div className="space-y-6">
            ...
            <div className="space-y-3">
              <Tooltip>
                ...
                <TooltipContent>
                  <p>Cria um backup completo dos dados atuais</p>
                </TooltipContent>
              </Tooltip>
              ...
              <Tooltip>
                ...
                <TooltipContent>
                  <p>Restaura o último backup salvo</p>
                </TooltipContent>
              </Tooltip>
              ...
              <Tooltip>
                ...
                <TooltipContent>
                  <p>Restaura configuração inicial da plataforma</p>
                </TooltipContent>
              </Tooltip>
            </div>
